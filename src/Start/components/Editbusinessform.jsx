    ...
    return (
        <div className='w-screen h-screen'>
            <div className='w-[28%] mx-auto flex flex-col items-center'>
                <p className="font-extrabold text-4xl mb-10 mt-4">Edit Your Business Details</p>
                <form className='flex flex-col justify-around w-9/12' onSubmit={handle_submit}>
                    ...
                    <button type="submit" className='py-3 bg-[#4100FA] rounded-3xl text-white font-bold  mt-5'>Save</button>
                </form>
            </div>
        </div>
