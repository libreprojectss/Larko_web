...
import { BsInputCursor, IoHandLeft, MdPublic } from 'react-icons/all'
...
function SettingSidebar() {
    ...
    return (
        <div className="sidebar px-2 shadow-sm border-r-2 border-gray-500 ml-16 w-[15vw] flex flex-col justify-evenly items-center">
            <div className="mt-14 mx-4 font-bold text-2xl text-center h-[5vh] ">
                Settings
            </div>

            <div className="sidebar__content w-full flex justify-center items-center mt-5 h-1/2 pb-24">
